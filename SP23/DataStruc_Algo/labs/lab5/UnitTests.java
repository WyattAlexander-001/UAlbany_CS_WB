...
public class UnitTests {
	...
	public void test1() throws Exception {
		...
		FloatArrays.bubbleSort(Arrays.copyOf(b, b.length));
		compare(b,b1);
	}
	...
	public void test2() throws Exception {
		...
		float[] b1 = Arrays.copyOf(b,b.length);
		FloatArrays.selectionSort(Arrays.copyOf(b, b.length));
		compare(b,b1);
	}
	...
	public void test3() throws Exception {
		...
		float[] b1 = Arrays.copyOf(b,b.length);
		FloatArrays.quickSort(Arrays.copyOf(b, b.length));
		compare(b,b1);
	}
